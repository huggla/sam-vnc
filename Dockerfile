...
ARG RUNDEPS="x11vnc xvfb openbox pcmanfm leafpad ttf-freefont gnome-icon-theme"
ARG EXECUTABLES="/usr/bin/Xvfb /usr/bin/x11vnc /usr/bin/openbox /usr/bin/pcmanfm /usr/bin/leafpad"
